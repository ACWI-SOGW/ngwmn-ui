...
let locString = '';
            ...
            if (!element.zeroLength && element.position.coordinates.start === element.position.coordinates.end ) {
                console.log('this is start ' + JSON.stringify(element.position.coordinates.start));
console.log('this is end '  + JSON.stringify(element.position.coordinates.end));
                ...
                let isZeroLength = true
                element.zeroLength = isZeroLength;
            ...
            if (!element.zeroLength) {
                console.log('this ran')
                console.log('this is start ' + loc.start)
                console.log('this is end ' + loc.end)
                locString = `${loc.start} - ${loc.end} ${unit}`;
            } else {
                // locString = element.zeroLength ? `${loc.start} - ${loc.end - 0.5} ${unit}`:
                locString = `${loc.start} - ${loc.end - 0.5} ${unit}`;
            }
