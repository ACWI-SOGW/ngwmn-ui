...
COOPERATOR_SERVICE_PATTERN_OLD = 'https://sifta.water.usgs.gov/Services/REST/Site/CustomerFunding.ashx?' \
                             'SiteNumber={site_no}&StartDate=10/1/{year}&EndDate={current_date}'
